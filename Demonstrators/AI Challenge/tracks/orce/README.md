...
## Build
- Pattern: `http in` (POST `/api/ai-challenge/<name>/run`) -> five function/LLM nodes
...
```
python3 ../../checker/validate_contract.py http://localhost:1880/api/ai-challenge/<name>/run CASE-2026-0002
curl -s -X POST -H 'Content-Type: application/json' \
     -d '{"case_id":"CASE-2026-0001"}' http://localhost:1880/api/ai-challenge/<name>/run
```
