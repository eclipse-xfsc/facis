...
**The detailed specifications for the Digital Contracting Service (DCS) are available in :**
- [Markdown Version](https://github.com/eclipse-xfs/facis/blob/main/DCS/specification/README.md)
- [PDF Version](https://github.com/eclipse-xfsc/facis/tree/main/DCS/specification/SRS_FACIS_DCS.pdf).
