...
**The detailed specifications for the Digital Contracting Service (DCS) can be found: [SRS_FACIS_DCS](https://github.com/Jessia2597/facis/tree/main/DCS/specification/SRS_FACIS_DCS.pdf).**
