...
class SmartCityConfig(BaseModel):
    ...
    latitude: float = Field(default=52.52, ge=-90.0, le=90.0, description="City latitude")
    longitude: float = Field(default=13.405, ge=-180.0, le=180.0, description="City longitude")
